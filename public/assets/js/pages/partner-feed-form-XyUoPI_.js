...
// ✅ CORRIGIDO — Requisição GET simples (sem preflight CORS)
// Documentação: https://support.google.com/waze/partners/answer/11486981
// ✅ CORRIGIDO — Formato real da resposta: { result: [{ names: [...], distance }] }
    ...
    if (geoToken) {
        try {
            ...
            if (res.ok) {
                ...
                // ✅ Formato real:
                // { "result":[{ "names":["R. Antônio Pereira Filho"], "distance": 4.23 }, ...], ... }
                ...
                if (streetName) {
                    ...
                    // A API do Waze não retorna cidade; Nominatim só enriquece 'reference'
